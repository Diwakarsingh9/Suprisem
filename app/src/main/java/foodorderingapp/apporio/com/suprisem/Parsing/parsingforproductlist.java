...
public class parsingforproductlist {
    ...
    public static void parsing(final Context c, final String category_id) {
...
//        pd.setCancelable(false);
        ...
        String urlforRest_food  = Apis_url.products+"&category_id="+category_id;
        ...
        sr = new StringRequest(Request.Method.GET, urlforRest_food, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Product_list_Activity.pb.setVisibility(View.GONE);
                try {
                    ...
                    Outer_all_products received2 = new Outer_all_products();
                    received2 = gson.fromJson(response, Outer_all_products.class);
                    ...
                    Product_list_Activity.lv.setAdapter(new Productlistadapter(c,pro_id,pro_name,pro_img,pro_status));
...
//                Menufragment.pb.setVisibility(View.GONE);
        ...
        queue.add(sr);
        Product_list_Activity.pb.setVisibility(View.VISIBLE);
    }
}
